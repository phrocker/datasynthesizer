...
import org.dataguardians.datasynth.code.comment.CommentGenerator;
...
/**
 * This class is a comment generator for Java unit tests. It includes methods for visiting method declarations and
...
public class JavaUnitTestGenerator {
    ...
    public JavaUnitTestGenerator(CommentGenerator generator, String fileOrDirectory, boolean saveToFile, String author, String date) {
    ...
    public List<String> generate() throws HttpException, IOException {
        SourceRoot sourceRoot = new SourceRoot(
                CodeGenerationUtils.mavenModuleRoot(JavaUnitTestGenerator.class).resolve("src/main/java"));
