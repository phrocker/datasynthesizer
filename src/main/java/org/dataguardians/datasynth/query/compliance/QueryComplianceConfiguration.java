 ...
 *
 * By default, the compliance configuration settings are set to the system defaults. Use the setComplianceConfiguration()
 * method to configure specific settings for your query. The getComplianceConfiguration() method can be called to return
