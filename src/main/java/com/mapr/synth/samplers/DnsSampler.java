...
public class DnsSampler extends FieldSampler {
    ...
    private final JsonNodeFactory factory = JsonNodeFactory.withExactBigDecimals(false);
    private final Random base = new Random();
    ...
    private final Exponential activeDistribution = new Exponential(1.0 / TimeUnit.MINUTES.toMillis(10), base);
    private Exponential active;

    // distribution of inactive times
    private final Exponential inActiveDistribution = new Exponential(1.0 / TimeUnit.HOURS.toMillis(4), base);
    ...
    private final IpAddressDistribution ip = new IpAddressDistribution();
