...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = IpV4AddressSampler.class, name = "ipv4"),
        ...
        @JsonSubTypes.Type(value = TextSampler.class, name = "text"),
...
public abstract class FieldSampler implements Sampler<JsonNode> {
    ...
    protected static FieldSampler constant(final double v) {
        return new FieldSampler() {
            private final DoubleNode sd = new DoubleNode(v);
